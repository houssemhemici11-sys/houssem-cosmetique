document.addEventListener('DOMContentLoaded', () => {
    const products = [
        { id: 15, name: "Dr.Althea 147 Barrier Cream", price: 3300, category: "Visage", description: "Crème réparatrice qui renforce la barrière cutanée.", image: "images/products/Dr_Althea_147_Barrier_Cream.jpg", stock: 6, rating: 4.6, reviews: 23, badge: null, skinTypes: ["Sèche", "Sensible"], nameAr: "دراثيا 147 كريم حاجز", descAr: "كريم مرمم يعزز حاجز البشرة." },
        { id: 16, name: "Dr.Althea 345 Cream", price: 3300, category: "Visage", description: "Soin apaisant à base de centella asiatica.", image: "images/products/Dr_Althea_345_Relief_Cream.jpg", stock: 9, rating: 4.5, reviews: 31, badge: null, skinTypes: ["Sensible", "Sèche"], nameAr: "دراثيا 345 كريم", descAr: "عناية مهدئة بخلاصة السنتيلا الآسيوية." },
        { id: 17, name: "Dr.Althea Vitamin C Serum", price: 3300, category: "Visage", description: "Sérum éclaircissant à la vitamine C pour un teint uniforme.", image: "images/products/Dr_Althea_Vitamin_C_Serum_Green.jpg", stock: 5, rating: 4.8, reviews: 47, badge: "Meilleure vente", skinTypes: ["Grasse", "Sèche", "Sensible", "Mixte"], nameAr: "دراثيا سيروم فيتامين C", descAr: "سيروم مفتّح بفيتامين C لتوحيد لون البشرة." },
        ...
        { id: 28, name: "Centella Gel Rose", price: 2600, category: "Visage", description: "Gel apaisant et rafraîchissant à la centella asiatica.", image: "images/products/SKIN1004_Deep_Cleansing_Foam.jpg", stock: 9, rating: 4.4, reviews: 24, badge: null, skinTypes: ["Grasse", "Mixte"], nameAr: "جل سنتيلا وردي", descAr: "جل مهدئ ومنعش بالسنتيلا الآسيوية." },
        ...
        { id: 30, name: "345 Cream Mist", price: 3300, category: "Visage", description: "Brume hydratante pour un teint frais toute la journée.", image: "images/products/Dr_Althea_345_Cream_Mist.jpg", stock: 1, rating: 4.3, reviews: 9, badge: null, skinTypes: ["Grasse", "Sèche", "Sensible", "Mixte"], nameAr: "345 رذاذ مرطب", descAr: "رذاذ مرطب لبشرة منتعشة طوال اليوم." },
        ...
        { id: 61, name: "Arencia Vitamin C Booster Shot", price: 2500, category: "Visage", description: "Sérum booster illuminateur et raffermissant à la vitamine C.", nameAr: "Arencia Vitamin C Booster Shot", descAr: "سيروم بوستر منير وشادّ بفيتامين C.", image: "images/products/Arencia_VitaminC_Booster.jpg", skinTypes: ["Grasse", "Sèche", "Mixte"], stock: 10, rating: 4.5, reviews: 9, badge: null },
        { id: 62, name: "EQQUAL Berry Bakuchiol Plumping Serum", price: 3500, category: "Visage", description: "Sérum repulpant au bakuchiol, alternative douce au rétinol.", nameAr: "EQQUAL Berry Bakuchiol Plumping Serum", descAr: "سيروم مكثف بالباكوشيول، بديل لطيف للريتينول.", image: "images/products/EQQUAL_Bakuchiol_Plumping.jpg", skinTypes: ["Sèche", "Mixte"], stock: 9, rating: 4.5, reviews: 10, badge: null },
        { id: 63, name: "EQQUAL Berry Hyaltoin Flooding Serum", price: 3500, category: "Visage", description: "Sérum ultra-hydratant à l'acide hyaluronique et à l'hyaltoin.", nameAr: "EQQUAL Berry Hyaltoin Flooding Serum", descAr: "سيروم مرطب للغاية بحمض الهيالورونيك والهيالتوين.", image: "images/products/EQQUAL_Hyaltoin_Flooding.jpg", skinTypes: ["Sèche", "Sensible"], stock: 9, rating: 4.5, reviews: 11, badge: null },
        { id: 64, name: "EQQUAL Berry Vitamin Illuminating Serum", price: 3500, category: "Visage", description: "Sérum illuminateur à la vitamine C pour un teint uniforme.", nameAr: "EQQUAL Berry Vitamin Illuminating Serum", descAr: "سيروم منير بفيتامين C لبشرة موحدة اللون.", image: "images/products/EQQUAL_Vitamin_Illuminating.jpg", skinTypes: ["Grasse", "Mixte"], stock: 9, rating: 4.5, reviews: 12, badge: null },
        { id: 65, name: "ORVA Expigment 4% Crème", price: 1500, category: "Visage", description: "Crème dépigmentante à l'hydroquinone, peaux sèches et sensibles.", nameAr: "ORVA Expigment 4% Crème", descAr: "كريم مفتّح بالهيدروكينون، للبشرة الجافة والحساسة.", image: "images/products/ORVA_Expigment.jpg", skinTypes: ["Sèche", "Sensible"], stock: 6, rating: 4.5, reviews: 13, badge: null },
        { id: 66, name: "Daylong extreme SPF50+", price: 2500, category: "Corps", description: "Lotion solaire liposomale extra résistante à l'eau, peaux extrêmement sensibles.", nameAr: "Daylong extreme SPF50+", descAr: "لوشن شمسي ليبوسومي مقاوم جداً للماء، للبشرة الحساسة جداً.", image: "images/products/Daylong_Extreme.jpg", skinTypes: ["Sensible"], stock: 8, rating: 4.5, reviews: 14, badge: null },
        { id: 67, name: "Dexeryl Crème", price: 2500, category: "Corps", description: "Traitement des sécheresses cutanées, hydrate durablement dès la naissance.", nameAr: "Dexeryl Crème", descAr: "علاج جفاف البشرة، يرطب لفترة طويلة منذ الولادة.", image: "images/products/Dexeryl_Creme.jpg", skinTypes: ["Sèche"], stock: 10, rating: 4.5, reviews: 15, badge: null },
        ...
        { id: 69, name: "PanOxyl Acne Creamy Wash", price: 3500, category: "Visage", description: "Nettoyant anti-acné au peroxyde de benzoyle 4%, visage et corps.", nameAr: "PanOxyl Acne Creamy Wash", descAr: "منظف مضاد لحب الشباب ببيروكسيد البنزويل 4%، للوجه والجسم.", image: "images/products/PanOxyl_Acne_Wash.jpg", skinTypes: ["Grasse", "Mixte"], stock: 9, rating: 4.5, reviews: 17, badge: null },
        { id: 70, name: "Bee Beauty Sirke & Saç Toniği", price: 1200, category: "Cheveux", description: "Tonique cheveux au vinaigre de fruits des bois, renforce et fait briller.", nameAr: "Bee Beauty Sirke & Saç Toniği", descAr: "تونر شعر بخل فواكه الغابة، يقوي الشعر ويمنحه لمعاناً.", image: "images/products/Bee_Beauty_Tonic.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 12, rating: 4.5, reviews: 18, badge: null },
        { id: 71, name: "Golden Rose Mattifying Fixing Spray", price: 1800, category: "Maquillage", description: "Spray fixateur de maquillage matifiant, prolonge la tenue toute la journée.", nameAr: "Golden Rose Mattifying Fixing Spray", descAr: "بخاخ مثبت للمكياج بتأثير مطفٍ، يطيل مدة ثبات المكياج طوال اليوم.", image: "images/products/Golden_Rose_Fixing_Spray.jpg", skinTypes: ["Grasse", "Mixte", "Sèche", "Sensible"], stock: 10, rating: 4.5, reviews: 16, badge: "Nouveau" },
        ...
        { id: 78, name: "Huda Beauty Baby Bake Mini Loose Baking & Setting Powder", price: 2000, category: "Maquillage", description: "Poudre libre mini format pour baking et fixation, estompe les pores et prolonge la tenue du maquillage sans effet cakey.", nameAr: "Huda Beauty Baby Bake Mini Loose Baking & Setting Powder", descAr: "بودرة سائبة بحجم صغير للبيكينغ والتثبيت، تُخفي المسام وتُطيل ثبات المكياج دون تكتل.", image: "images/products/Huda_Beauty_Baby_Bake_Powder.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 10, rating: 4.6, reviews: 9, badge: "Nouveau" },
        { id: 79, name: "Email Diamant Blancheur Fraîcheur", price: 1500, category: "Visage", description: "Dentifrice quotidien à l'oxygène actif et au bicarbonate, pour un éclat blancheur et une haleine fraîche durable.", nameAr: "Email Diamant Blancheur Fraîcheur", descAr: "معجون أسنان يومي بالأكسجين النشط وبيكربونات الصودا، لبياض مشرق ونفس منعش يدوم طويلاً.", image: "images/products/Email_Diamant_Blancheur_Fraicheur.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 15, rating: 4.5, reviews: 8, badge: "Nouveau" },
        { id: 80, name: "Email Diamant Blancheur Absolue", price: 1500, category: "Visage", description: "Dentifrice au fluor avec 5 actions blancheur : protège, blanchit, purifie, répare et anti-taches, pour un sourire éblouissant dès 5 jours.", nameAr: "Email Diamant Blancheur Absolue", descAr: "معجون أسنان بالفلورايد بخمس فوائد للبياض: يحمي، يبيض، ينقي، يصلح ومضاد للبقع، لابتسامة مشرقة من 5 أيام.", image: "images/products/Email_Diamant_Blancheur_Absolue.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 15, rating: 4.6, reviews: 10, badge: "Nouveau" },
        { id: 81, name: "L'Oréal Paris Panorama Mascara", price: 1500, category: "Maquillage", description: "Mascara volume panoramique avec brosse extra-large pour des cils longs et fournis en un seul geste, effet regard grand angle.", nameAr: "L'Oréal Paris Panorama Mascara", descAr: "ماسكارا بفرشاة عريضة للحصول على رموش طويلة وكثيفة من ضربة واحدة، بمظهر بانورامي واسع.", image: "images/products/LOreal_Panorama_Mascara.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 12, rating: 4.5, reviews: 11, badge: "Nouveau" },
    ];
