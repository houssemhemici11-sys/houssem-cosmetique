document.addEventListener('DOMContentLoaded', () => {
    const products = [
        ...
        { id: 71, name: "Gisou Honey Infused Lip Oil - Honey Gold", price: 1800, category: "Maquillage", description: "Huile à lèvres nourrissante au miel d'abeille Mirsalehi, fini brillant doré.", nameAr: "Gisou Honey Infused Lip Oil - Honey Gold", descAr: "زيت شفاه مغذٍ بعسل ميرصالحي، لمعان ذهبي.", image: "images/products/Gisou_Honey_Gold.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 6, rating: 4.7, reviews: 22, badge: "Nouveau" },
        { id: 72, name: "Gisou Honey Infused Lip Oil - Strawberry Sorbet", price: 1800, category: "Maquillage", description: "Huile à lèvres nourrissante au miel d'abeille Mirsalehi, teinte fraise rosée.", nameAr: "Gisou Honey Infused Lip Oil - Strawberry Sorbet", descAr: "زيت شفاه مغذٍ بعسل ميرصالحي، بلون فراولة وردي.", image: "images/products/Gisou_Strawberry_Sorbet.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 4, rating: 4.7, reviews: 19, badge: "Nouveau" },
        { id: 73, name: "Gisou Honey Infused Lip Oil - Orange corail", price: 1800, category: "Maquillage", description: "Huile à lèvres nourrissante au miel d'abeille Mirsalehi, teinte orange corail.", nameAr: "Gisou Honey Infused Lip Oil - Orange corail", descAr: "زيت شفاه مغذٍ بعسل ميرصالحي، بلون برتقالي مرجاني.", image: "images/products/Gisou_Orange.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 5, rating: 4.7, reviews: 14, badge: "Nouveau" },
        { id: 74, name: "Gisou Honey Infused Lip Oil - Rose nacré", price: 1800, category: "Maquillage", description: "Huile à lèvres nourrissante au miel d'abeille Mirsalehi, teinte rose nacrée.", nameAr: "Gisou Honey Infused Lip Oil - Rose nacré", descAr: "زيت شفاه مغذٍ بعسل ميرصالحي، بلون وردي لؤلؤي.", image: "images/products/Gisou_Pink.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 5, rating: 4.7, reviews: 14, badge: "Nouveau" },
        { id: 75, name: "Gisou Honey Infused Lip Oil - Rouge cerise", price: 1800, category: "Maquillage", description: "Huile à lèvres nourrissante au miel d'abeille Mirsalehi, teinte rouge cerise.", nameAr: "Gisou Honey Infused Lip Oil - Rouge cerise", descAr: "زيت شفاه مغذٍ بعسل ميرصالحي، بلون أحمر كرزي.", image: "images/products/Gisou_Red.jpg", skinTypes: ["Sèche", "Grasse", "Sensible", "Mixte"], stock: 5, rating: 4.7, reviews: 14, badge: "Nouveau" },
    ];
